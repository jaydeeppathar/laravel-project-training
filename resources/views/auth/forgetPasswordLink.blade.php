    ...
    <div class="card-body login-card-body">
      ...
      <form action="{{ route('reset.password.post') }}" method="post">
        ...
        <div class="input-group mb-3">
           <input type="text" id="email_address" class="form-control" value="email" name="email" required autofocus>
        ...
        <div class="input-group mb-3">
           <input type="password" id="password" class="form-control" value="password" name="password" required autofocus>
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
        ...
        <div class="input-group mb-3">
           <input type="password" id="password-confirm" value="retype_password" class="form-control" name="password_confirmation" required autofocus>
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
